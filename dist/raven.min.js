        ...
        function(a, b, c) {
          (function(c) {
            ...
            var g = a(6),
              ...
              w = j.urlencode,
              x = j.uuid4,
              y = j.htmlTreeAsString,
              z = j.isSameException,
              A = j.isSameStacktrace,
              B = j.parseUrl,
              C = j.fill,
              D = a(2).wrapMethod,
            ...
            (f.prototype = {
              ...
              config: function(a, b) {
                ...
                b &&
                  ...
                  (d.ignoreErrors = v(d.ignoreErrors)),
                  (d.ignoreUrls = !!d.ignoreUrls.length && v(d.ignoreUrls)),
                  (d.whitelistUrls = !!d.whitelistUrls.length && v(d.whitelistUrls)),
                  (d.includePaths = v(d.includePaths)),
              ...
              wrap: function(a, b, c) {
                function d() {
                  var d = [],
                    f = arguments.length,
                    g = !a || (a && a.deep !== !1);
                  for (c && n(c) && c.apply(this, arguments); f--; )
                ...
                var e = this;
                if (m(b) && !n(a)) return a;
                if ((n(a) && ((b = a), (a = void 0)), !n(b))) return b;
                try {
                  if (b.J) return b;
                  if (b.K) return b.K;
                } catch (f) {
              ...
              captureException: function(a, b) {
                if (!k(a))
                  return this.captureMessage(
                    a,
                    r({trimHeadFrames: 1, stacktrace: !0}, b)
                  );
                this.d = a;
                try {
              ...
              captureMessage: function(a, b) {
                if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(a)) {
                  ...
                  var f = g.computeStackTrace(c),
                    ...
                    j = (i && i.url) || '';
                  if (
                    (!this.k.ignoreUrls.test || !this.k.ignoreUrls.test(j)) &&
                    (!this.k.whitelistUrls.test || this.k.whitelistUrls.test(j))
                  ) {
              ...
              captureBreadcrumb: function(a) {
                var b = r({timestamp: d() / 1e3}, a);
                if (n(this.k.breadcrumbCallback)) {
              ...
              showReportDialog: function(a) {
                if (H) {
                  ...
                  var g = this.G(this.D(c)),
                    h = H.createElement('script');
                  (h.async = !0),
                    (h.src = g + '/api/embed/error-page/' + e),
                    (H.head || H.body).appendChild(h);
                }
              },
              I: function() {
                var a = this;
              ...
              R: function(a, b) {
                ...
                if (this.b) {
                  (b = b || {}),
                    ...
                    H.createEvent
                      ? ((c = H.createEvent('HTMLEvents')), c.initEvent(a, !0, !0))
                      : ((c = H.createEventObject()), (c.eventType = a));
                  for (d in b) u(b, d) && (c[d] = b[d]);
                  if (H.createEvent) H.dispatchEvent(c);
                  else
                    try {
              ...
              B: function() {
                      ...
                      function(c) {
                        return function(d) {
                          ...
                          for (
                            ...
                            a(g[h], f);
                          return (
                            'onreadystatechange' in f && n(f.onreadystatechange)
                              ? C(f, 'onreadystatechange', function(a) {
                ...
                c.xhr &&
                  ...
                  C(
                    ...
                    function(a) {
                      return function(c, d) {
                        ...
                        'string' == typeof h
                          ? (g = h)
                          : 'Request' in G && h instanceof G.Request
                  ...
                  c.dom &&
                    this.b &&
                    (H.addEventListener
                      ? (H.addEventListener('click', b.S('click'), !1),
                        H.addEventListener('keypress', b.U(), !1))
                      : (H.attachEvent('onclick', b.S('click')),
                        H.attachEvent('onkeypress', b.U())));
                var f = G.chrome,
                  g = f && f.app && f.app.runtime,
                  h = !g && G.history && history.pushState;
                if (c.location && h) {
                  var i = G.onpopstate;
                ...
                if (c.console && 'console' in G && console.log) {
                  ...
                  q(['debug', 'info', 'warn', 'error', 'log'], function(a, b) {
                    D(console, b, j);
                  });
                }
              },
              ...
              Z: function(a) {
                ...
                if ((a.message && (a.message = s(a.message, b)), a.exception)) {
                ...
                return (
                  d &&
                    (d.url && (d.url = s(d.url, this.k.maxUrlLength)),
                    d.Referer && (d.Referer = s(d.Referer, this.k.maxUrlLength))),
              ...
              $: function(a) {
                for (
                  ...
                  if (
                    ((c = a.values[f]),
                    c.hasOwnProperty('data') && l(c.data) && !t(c.data))
                  ) {
                    d = r({}, c.data);
              ...
              _: function() {
                if (this.c || this.b) {
                  ...
                  return (
                    ...
                    this.b &&
                      (H.location && H.location.href && (a.url = H.location.href),
                      H.referrer &&
                        (a.headers || (a.headers = {}),
                        (a.headers.Referer = H.referrer))),
                    a
                  );
                }
              },
              ...
              da: function(a) {
                ...
                return (
                  ...
                  (a.stacktrace || b.stacktrace
                    ? A(a.stacktrace, b.stacktrace)
                    : (!a.exception && !b.exception) || z(a.exception, b.exception))
                );
              },
              ea: function(a) {
                if (!this.ca()) {
              ...
              P: function(a) {
                ...
                if (
                  ...
                  (a = r(c, a)),
                  (a.tags = r(r({}, this.j.tags), a.tags)),
                  (a.extra = r(r({}, this.j.extra), a.extra)),
                  (a.extra['session:duration'] = d() - this.r),
                  this.t &&
                    this.t.length > 0 &&
                    (a.breadcrumbs = {values: [].slice.call(this.t, 0)}),
                  p(a.tags) && delete a.tags,
                  ...
                  n(b.dataCallback) && (a = b.dataCallback(a) || a),
                  a && !p(a) && (!n(b.shouldSendCallback) || b.shouldSendCallback(a)))
                )
                  return this.ca()
              ...
              ha: function(a) {
                var b = G.XMLHttpRequest && new G.XMLHttpRequest();
                if (b) {
              ...
              Q: function(a, b) {
                m(b) ? delete this.j[a] : (this.j[a] = r(this.j[a] || {}, b));
              }
            }),
      ...
      5: [
        function(a, b, c) {
          (function(a) {
            ...
            function j(a, b) {
              var c, d;
              if (e(a.length)) for (c in a) n(a, c) && b.call(null, c, a[c]);
            ...
            function r() {
              var a = y.crypto || y.msCrypto;
              if (!e(a) && a.getRandomValues) {
            ...
            function t(a) {
              ...
              if (
                (h.push(a.tagName.toLowerCase()),
                a.id && h.push('#' + a.id),
                (b = a.className),
                b && g(b))
              )
                for (c = b.split(/\s+/), f = 0; f < c.length; f++) h.push('.' + c[f]);
            ...
            function v(a, b) {
              return (
                ...
                ((a = a.values[0]),
                (b = b.values[0]),
                a.type === b.type && a.value === b.value && w(a.stacktrace, b.stacktrace))
              );
            }
            function w(a, b) {
              if (u(a, b)) return !1;
